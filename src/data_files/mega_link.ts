...
export const servicesData = [
  {
    ...
    description:
      "Dive deep into helpful guides and explanations for all of MidasTech's features",
    icon: "guides",
    url: "#",
  },
  {
  ...
  },
  {
    title: "Simple Plans",
    description:
      "Boost your efficiency with MidasTech's straightforward, value-driven plans",
    icon: "sparks",
    url: "#",
  },
  {
    title: "Community Forum",
    description: "Learn, share, and connect with other MidasTech users",
    icon: "community",
    url: "#",
  },
];
...
export const successStoriesData = [
  {
    ...
    description:
      "See how MidasTech has empowered businesses of all sizes to achieve outstanding results.",
    learnMoreUrl: "#",
  },
];
